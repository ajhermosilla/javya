...
class TestCreateSetlist:
    ...
    async def test_create_setlist_full(
        self, client: AsyncClient, auth_headers: dict, sample_setlist_data: dict[str, Any]
    ) -> None:
        """Test creating a setlist with all fields."""
        response = await client.post("/api/v1/setlists/", json=sample_setlist_data, headers=auth_headers)
    ...
    async def test_create_setlist_minimal(
        self, client: AsyncClient, auth_headers: dict, sample_setlist_data_minimal: dict[str, Any]
    ) -> None:
        """Test creating a setlist with only required fields."""
        response = await client.post("/api/v1/setlists/", json=sample_setlist_data_minimal, headers=auth_headers)
    ...
    async def test_create_setlist_with_songs(
        ...
        song1_response = await client.post("/api/v1/songs/", json=sample_song_data, headers=auth_headers)
        song1_id = song1_response.json()["id"]

        song2_response = await client.post(
            "/api/v1/songs/", json={"name": "Second Song", "lyrics": "Some lyrics"}, headers=auth_headers
        )
        ...
        response = await client.post("/api/v1/setlists/", json=setlist_data, headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_create_setlist_missing_name(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test that creating a setlist without name fails."""
        response = await client.post("/api/v1/setlists/", json={}, headers=auth_headers)

        assert response.status_code == 422

    @pytest.mark.asyncio
    async def test_create_setlist_whitespace_name(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test that whitespace-only name is rejected."""
        response = await client.post("/api/v1/setlists/", json={"name": "   "}, headers=auth_headers)

        assert response.status_code == 422

    @pytest.mark.asyncio
    async def test_create_setlist_invalid_event_type(self, client: AsyncClient, auth_headers: dict) -> None:
    ...
    async def test_create_setlist_invalid_song_id(
        ...
        with pytest.raises(IntegrityError):
            await client.post("/api/v1/setlists/", json=setlist_data, headers=auth_headers)
...
class TestListSetlists:
    ...
    async def test_list_setlists_with_data(
        ...
        await client.post("/api/v1/setlists/", json=sample_setlist_data, headers=auth_headers)
        await client.post("/api/v1/setlists/", json={"name": "Second Setlist"}, headers=auth_headers)
    ...
    async def test_list_setlists_search(
        ...
        await client.post("/api/v1/setlists/", json=sample_setlist_data, headers=auth_headers)
        await client.post("/api/v1/setlists/", json={"name": "Wednesday Prayer"}, headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_list_setlists_pagination(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test pagination with skip and limit."""
        for i in range(5):
            await client.post("/api/v1/setlists/", json={"name": f"Setlist {i}"}, headers=auth_headers)
    ...
    async def test_list_setlists_includes_song_count(
        ...
        song_response = await client.post("/api/v1/songs/", json=sample_song_data, headers=auth_headers)
...
class TestGetSetlist:
    ...
    async def test_get_setlist_success(
        ...
        create_response = await client.post("/api/v1/setlists/", json=sample_setlist_data, headers=auth_headers)
    ...
    async def test_get_setlist_with_songs(
        ...
        create_response = await client.post("/api/v1/setlists/", json=setlist_data, headers=auth_headers)
        setlist_id = create_response.json()["id"]
...
class TestUpdateSetlist:
    ...
    async def test_update_setlist_success(
        ...
        response = await client.put(f"/api/v1/setlists/{setlist_id}", json=updated_data, headers=auth_headers)
    ...
    async def test_update_setlist_replace_songs(
        ...
        song2_response = await client.post("/api/v1/songs/", json={"name": "Second Song"}, headers=auth_headers)
        song2_id = song2_response.json()["id"]
    ...
    async def test_update_setlist_not_found(
        ...
        response = await client.put(f"/api/v1/setlists/{fake_id}", json=sample_setlist_data, headers=auth_headers)
...
class TestDeleteSetlist:
    ...
    async def test_delete_setlist_success(
        ...
        response = await client.delete(f"/api/v1/setlists/{setlist_id}", headers=auth_headers)
    ...
    async def test_delete_setlist_cascades_songs(
        ...
        # Delete setlist
        await client.delete(f"/api/v1/setlists/{setlist_id}", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_delete_setlist_not_found(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test deleting a non-existent setlist returns 404."""
        fake_id = str(uuid4())

        response = await client.delete(f"/api/v1/setlists/{fake_id}", headers=auth_headers)

        assert response.status_code == 404

    @pytest.mark.asyncio
    async def test_delete_setlist_invalid_id(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test deleting with invalid UUID format."""
        response = await client.delete("/api/v1/setlists/not-a-uuid", headers=auth_headers)
...
class TestExportSetlist:
    ...
    async def test_export_freeshow_success(
        ...
        response = await client.get(f"/api/v1/setlists/{setlist_id}/export/freeshow", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_export_freeshow_not_found(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test exporting a non-existent setlist returns 404."""
        fake_id = str(uuid4())

        response = await client.get(f"/api/v1/setlists/{fake_id}/export/freeshow", headers=auth_headers)
    ...
    async def test_export_quelea_success(
        ...
        response = await client.get(f"/api/v1/setlists/{setlist_id}/export/quelea", headers=auth_headers)
    ...
    @pytest.mark.asyncio
    async def test_export_quelea_not_found(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test exporting a non-existent setlist returns 404."""
        fake_id = str(uuid4())

        response = await client.get(f"/api/v1/setlists/{fake_id}/export/quelea", headers=auth_headers)
...
class TestExportPDF:
    ...
    @pytest.mark.asyncio
    async def test_export_pdf_not_found(self, client: AsyncClient, auth_headers: dict) -> None:
        """Test exporting a non-existent setlist returns 404."""
        fake_id = str(uuid4())
